...
const Hero = () => {
  ...
  const floatingAnimation = {
    ...
    transition: {
      duration: 4,
      repeat: Infinity,
      repeatType: "mirror", // "reverse" -> "mirror" for type compatibility
      ease: "easeInOut"
    }
  };

  return (
    <section className="relative overflow-hidden pt-16 pb-24 sm:pt-24" ref={heroRef}>
      {/* Background elements */}
      <motion.div 
      ...
      >
        ...
        >
          ...
          <rect className="bg-pattern-rect" width="100%" height="100%" strokeWidth={0} fill="url(#e813992c-7d03-4cc4-a2bd-151760b470a0)" />
        </svg>
      </motion.div>
            ...
            <div className="rounded-md bg-white shadow-xl ring-1 ring-gray-900/5 overflow-hidden">
              <svg ref={svgRef} width="100%" height="100%" viewBox="0 0 1000 600" preserveAspectRatio="xMidYMid meet">
                ...
                <g transform="translate(50, 50)">
                  {/* Dashboard header */}
                  <rect width="900" height="60" rx="4" fill="#FFFFFF" stroke="#E5E7EB" strokeWidth="1" />
                  <text x="20" y="35" fontSize="18" fontWeight="600" fill="#1E40AF">SalePilot Analytics</text>
                  <circle cx="850" cy="30" r="20" fill="#E6F0FF" />
                  <text x="850" y="35" fontSize="14" fontWeight="600" fill="#3B82F6" textAnchor="middle">JD</text>
                  
                  {/* Stats row */}
                  <g transform="translate(0, 80)">
                    {[0, 1, 2, 3].map((i) => (
                      <g key={i} transform={`translate(${i * 225}, 0)`}>
                        <rect width="215" height="100" rx="4" fill="#FFFFFF" stroke="#E5E7EB" strokeWidth="1" />
                        <text x="20" y="30" fontSize="14" fill="#64748B">
                          {["API Calls", "Response Time", "Error Rate", "Uptime"][i]}
                        </text>
                        <text x="20" y="60" fontSize="24" fontWeight="600" fill="#111827">
                          {i === 0 ? counts.apiCalls.toLocaleString() : 
                           i === 1 ? counts.responseTime.toString() + "ms" : 
                           i === 2 ? counts.errorRate.toString() + "%" : 
                           counts.uptime.toString() + "%"}
                        </text>
                        <text x="20" y="80" fontSize="12" fill="#64748B">
                          <tspan fill={["#16A34A", "#16A34A", "#16A34A", "#16A34A"][i]}>▲ </tspan>
                  ...
                  <g transform="translate(0, 200)">
                    <rect width="600" height="300" rx="4" fill="#FFFFFF" stroke="#E5E7EB" strokeWidth="1" />
                    <text x="20" y="30" fontSize="16" fontWeight="500" fill="#111827">Performance Metrics</text>
                    
                    {/* Chart grid */}
                    {[0, 1, 2, 3, 4].map((i) => (
                      <line key={i} x1="50" y1={70 + i * 50} x2="550" y2={70 + i * 50} stroke="#F3F4F6" strokeWidth="1" />
                    ))}
                    ...
                    {/* X-axis labels */}
                    {[0, 1, 2, 3, 4, 5, 6].map((i) => (
                      <text key={i} x={50 + i * 83} y="280" fontSize="12" fill="#64748B" textAnchor="middle">
                  ...
                  <g transform="translate(620, 200)">
                    <rect width="280" height="140" rx="4" fill="#FFFFFF" stroke="#E5E7EB" strokeWidth="1" />
                    <text x="20" y="30" fontSize="14" fontWeight="500" fill="#111827">Team Activity</text>
                    ...
                    {[0, 1, 2].map((i) => (
                      <g key={i} transform={`translate(20, ${50 + i * 30})`}>
                        ...
                        <text x="30" y="14" fontSize="12" fill="#4B5563">
                          {["API update deployed", "Documentation updated", "Client meeting scheduled"][i]}
                        </text>
                      </g>
                    ))}
                  </g>
                  ...
                  <g transform="translate(620, 360)">
                    <rect width="280" height="140" rx="4" fill="#FFFFFF" stroke="#E5E7EB" strokeWidth="1" />
                    <text x="20" y="30" fontSize="14" fontWeight="500" fill="#111827">Client Messages</text>
                    
                    <rect x="20" y="50" width="240" height="30" rx="4" fill="#F3F4F6" />
                    <text x="30" y="70" fontSize="12" fill="#6B7280">Latest feedback from Sarah J.</text>
                    
                    <motion.rect 
                      x="20" y="90" width="240" height="30" rx="15" fill="#EFF6FF"
                      animate={{ 
                        opacity: [0.8, 1, 0.8],
                        scale: [0.98, 1, 0.98] 
                      }}
                    ...
                    />
                    <text x="140" y="110" fontSize="12" fill="#3B82F6" textAnchor="middle">Reply to messages</text>
                  </g>
                </g>
              </svg>
            </div>
